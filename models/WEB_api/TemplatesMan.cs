...
{  
    class TemplatesMan
    {
        ...
        static string[] utf8 = {"%D0%90","%D0%91", "%D0%92","%D0%93",
			...
			"%D1%8E", "%D1%8F","%20", "%3A", "%2F", "%2C", "%21", "%40", "%3F", "%3D", "%29", "%7C", "%22", "%23", "%09", "%0D%0A", "%D1%96", "%2B", "+", "%28",
            "%27", "%D1%97", "%25", "%D1%94", "%D0%86", "%C2%A0", "%E2%84", "%96", "%5B", "%5D", "%3B",
            "%3c", "%3e", "%3C", "%3E", "%7B", "%7D"     };
        ...
        static string[] utf8Pref25 = {"%25D0%2590","%25D0%2591", "%25D0%2592","%25D0%2593",
            ...
            "%27", "%25D1%2597", "%25", "%25D1%2594", "%25D0%2586", "%25C2%25A0", "%25E2%2584", "%96", "%5B", "%5D", "%3B",
            "%3c", "%3e", "%3C", "%3E", "%7B", "%7D"     };
        ...
        public static object LoadAppSettings(string name)
        {
            ...
            object rez = null;
            RegistryKey rk = Registry.CurrentUser.OpenSubKey(@"SOFTWARE\Kibitz\server");
            if (rk == null)
            {
                Registry.CurrentUser.CreateSubKey(@"SOFTWARE\Kibitz\server");
            }
            else
            {
        ...
        {
            if (v == null) { return; }
            RegistryKey rk = Registry.CurrentUser.OpenSubKey(@"SOFTWARE\Kibitz\server", true);
            rk.SetValue(name, v);
            rk.Close();
        }
